...
function Footer() {
  return (
    <footer classNameName="bg-dark" id="tempaltemo_footer">
        <div classNameName="container">
            <div className="row">

                <div className="col-md-4 pt-5">
                    <h2 className="h2 text-success border-bottom pb-3 border-light logo">FavidaShop</h2>
                    <ul className="list-unstyled text-light footer-link-list">
                        <li>
                            <i className="fas fa-map-marker-alt fa-fw"></i>
                            40 Harrison Street, Ejigbo, Lagos.
                        </li>
                        <li>
                            <i className="fa fa-phone fa-fw"></i>
                            <a className="text-decoration-none" href="tel:01-480-8029">01-480-8029</a>
                        </li>
                        <li>
            ...
            <div className="row text-light mb-4">
                ...
                <div className="col-auto">
                    <label className="sr-only" for="subscribeEmail">mail@favidashop.biz</label>
                ...
                <div className="row pt-2">
                    <div className="col-12">
                        <p className="text-left text-light">
                            Copyright &copy; 2023 FavidaShop 
